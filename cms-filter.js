function initBasicFilterSetupMultiMatch() {
  ...
  groups.forEach(group => {
    // Guard: voorkom dubbele init op dezelfde group (bv. eerste load + Barba once)
...
// Eerste load — werkt ook als DOMContentLoaded al voorbij is
...
// Barba — opnieuw initialiseren na elke transitie (guarded zodat het ook werkt zonder Barba)
if (typeof barba !== 'undefined') {
  barba.hooks.after(() => initBasicFilterSetupMultiMatch());
}
